...
import static pe.edu.unmsm.fisi.upg.ads.cleancode.domain.Constants.BROWSER_INTERNET_EXPLORER_INITIALS;
...
public class WebBrowser {
	...
	private BrowserName TranslateStringToBrowserName(String name) {
		if (name.contains(BROWSER_INTERNET_EXPLORER_INITIALS)) {
